...
describe('Society Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'society', component: SocietyComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to societyService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSocietyIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSocietyIdentifier).toHaveBeenCalledWith(entity);
