...
describe('ParameterLookup routing resolve service', () => {
  ...
  let resultParameterLookup: IParameterLookup | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultParameterLookup).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IParameterLookup>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
