...
describe('SecurityPermission routing resolve service', () => {
  ...
  let resultSecurityPermission: ISecurityPermission | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSecurityPermission).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISecurityPermission>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
